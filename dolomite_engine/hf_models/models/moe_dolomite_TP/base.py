...
class MoEDolomitePreTrainedModel_TP(MoEDolomitePreTrainedModel):
    _no_split_modules = ["MoEDolomiteBlock_TP"]

    def __init__(self, config: MoEDolomiteConfig, *args, **kwargs):
        MoEDolomitePreTrainedModel.__init__(self, config, *args, **kwargs)

        self.tensor_parallel_word_embeddings = kwargs.get("tensor_parallel_word_embeddings", False)
        self.sequence_parallel = kwargs.get("sequence_parallel", False)


class MoEDolomiteModel_TP(MoEDolomitePreTrainedModel_TP, MoEDolomiteModel):
